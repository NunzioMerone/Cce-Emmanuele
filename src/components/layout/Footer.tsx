    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Una comunità di credenti che cerca di seguire Gesù Cristo e vivere
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <span>Via Gaetano de Rosa 81, Napoli</span>
              </li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          ...
          <p className="text-sm text-gray-500">Giovanni 3:16</p>
          <p className="text-sm text-gray-500 mt-4">
            © {new Date().getFullYear()} Chiesa Cristiana Evangelica Emmanuele.
